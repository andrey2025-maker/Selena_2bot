...
class Config:
    ...
    REQUIRED_GROUP_ID = -5212603352  # ЗАМЕНИТЕ НА ВАШ ID ГРУППЫ
    ...
    AVAILABLE_FRUITS_EN = [
        ...
        "Volt Ginkgo", "Cranberry", "Acorn", "Gingerbread", "Candycane"
    ]
    ...
    PUBLISH_GROUP_ID = -5212603352  # Тот же ID что и для проверки подписок
